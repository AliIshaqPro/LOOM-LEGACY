...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
  ...
  <%= link_to 'Edit Profile', edit_${singular_role}_registration_path, class: "btn btn-primary w-100" %>
    ...
    <div class="offcanvas offcanvas-start" data-bs-scroll="true"
      ...
      <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasScrollingLabel">LOOMS-LEGACY</h5>
    ...
    <h1 style="text-align: center; font-size: 60px; padding-top: 55px;">WELCOME BACK<br> TO LOOMS LEGACY</h1>
